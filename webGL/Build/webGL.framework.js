...
var ASM_CONSTS = {
  4544720: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4544775: ($0) => { performance.now = function() { return $0; }; },  
 4544823: ($0) => { performance.now = function() { return $0; }; },  
 4544871: () => { performance.now = Module['emscripten_get_now_backup']; }
};
